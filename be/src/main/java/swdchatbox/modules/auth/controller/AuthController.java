package swdchatbox.modules.auth.controller;
...
import swdchatbox.modules.auth.dto.request.GoogleLoginRequest;
import swdchatbox.modules.auth.dto.request.ForgotPasswordRequest;
import swdchatbox.modules.auth.dto.request.LoginRequest;
import swdchatbox.modules.auth.dto.request.RegisterRequest;
import swdchatbox.modules.auth.dto.request.ResendVerificationRequest;
import swdchatbox.modules.auth.dto.request.ResetPasswordRequest;
import swdchatbox.modules.auth.dto.request.UpdateRoleRequest;
import swdchatbox.modules.auth.dto.response.AuthResponse;
import swdchatbox.modules.auth.dto.response.ResendVerificationResponse;
import swdchatbox.modules.auth.service.AuthService;
import swdchatbox.modules.auth.service.EmailVerificationService;
import swdchatbox.modules.auth.service.PasswordResetService;
...
public class AuthController {
    ...
    public ResponseEntity<UserResponse> me(Authentication authentication) {
        ...
        User user = userRepository.findByEmail(email)
                .orElseThrow(() -> new swdchatbox.shared.exception.AuthException("User not found"));
