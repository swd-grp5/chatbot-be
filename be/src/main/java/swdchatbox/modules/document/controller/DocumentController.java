...
import swdchatbox.modules.document.dto.request.DocumentFilterRequest;
import swdchatbox.modules.document.dto.request.DocumentUpdateRequest;
import swdchatbox.modules.document.dto.request.DocumentUploadRequest;
import swdchatbox.modules.document.dto.response.DocumentChunkResponse;
...
import swdchatbox.modules.document.dto.response.DocumentPreviewResponse;
import swdchatbox.modules.document.dto.response.DocumentViewResponse;
...
import swdchatbox.modules.document.service.DocumentIndexingService;
...
//    }
    ...
    public ResponseEntity<List<DocumentChunkResponse>> chunks(@PathVariable UUID id) {
        return ResponseEntity.ok(documentIndexingService.getChunks(id).stream().map(swdchatbox.modules.document.mapper.DocumentChunkMapper::toResponse).toList());
    }
    ...
    public ResponseEntity<PageResponse<DocumentResponse>> getAll(
            ...
            @Parameter(description = "Lọc theo trạng thái index") @RequestParam(required = false) swdchatbox.modules.document.enums.DocumentStatus status,
